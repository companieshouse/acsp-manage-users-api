...
locals {
  ...
  lb_listener_paths          = ["/acsps/*/memberships*", "/acsps/*/memberships?*", "/acsps/*/memberships/lookup*", "/acsps/*/memberships/lookup?*", "/acsps/memberships/*", "/user/acsps/memberships*", "/user/acsps/memberships?*", "/acsp-manage-users-api/healthcheck"]

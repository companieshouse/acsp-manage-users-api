package uk.gov.companieshouse.acsp.manage.users.email.model.added;

import static uk.gov.companieshouse.acsp.manage.users.email.model.MessageType.CONFIRM_YOU_ARE_A_STANDARD_MEMBER_MESSAGE_TYPE;

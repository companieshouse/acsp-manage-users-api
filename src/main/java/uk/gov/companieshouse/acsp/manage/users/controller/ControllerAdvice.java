...
public class ControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public static final String ACSP_MANAGE_USERS_API = "acsp_manage_users_api";
    ...
    public Errors onInternalServerErrorRuntimeException(InternalServerErrorRuntimeException e, HttpServletRequest request) {
        ...
        Errors errors = new Errors();
        errors.addError(Err.invalidBodyBuilderWithLocation(ACSP_MANAGE_USERS_API).withError(e.getMessage()).build());
        return errors;
    }

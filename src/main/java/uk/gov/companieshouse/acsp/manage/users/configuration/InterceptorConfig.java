...
import uk.gov.companieshouse.acsp.manage.users.interceptor.AcspCreationPermissionInterceptor;
...
public class InterceptorConfig implements WebMvcConfigurer {
    ...
    private final AcspCreationPermissionInterceptor acspPermissionInterceptor;
  ...
  public InterceptorConfig( final LoggingInterceptor loggingInterceptor, @Qualifier("authorizationInterceptor") final AuthorizationInterceptor authorizationInterceptor, final AuthorizationAndInternalUserInterceptors authorizationAndInternalUserInterceptors,
          final AcspCreationPermissionInterceptor acspPermissionInterceptor
          ) {
        this.loggingInterceptor = loggingInterceptor;
        this.authorizationInterceptor = authorizationInterceptor;
        this.authorizationAndInternalUserInterceptors = authorizationAndInternalUserInterceptors;
      this.acspPermissionInterceptor = acspPermissionInterceptor;
  }
    ...
    registry.addInterceptor( authorizationInterceptor )
        ...
        registry.addInterceptor( acspPermissionInterceptor )
                .addPathPatterns( "/acsps/*/memberships" );

...
public class MembershipService {
    ...
    private final Storage acspMembersRepository;
    private final CollectionTransformer acspMembershipCollectionMappers;

    public MembershipService( final Storage acspMembersRepository, final CollectionTransformer acspMembershipCollectionMappers ) {
    ...
    public Optional<StorageModel> fetchMembershipDao( final String membershipId ) {
    ...
    @Transactional( readOnly = true )
    public List<StorageModel> fetchMembershipDaos( final String userId, final boolean includeRemoved ) {
    ...
    @Transactional( readOnly = true )
    public Optional<StorageModel> fetchActiveAcspMembership( final String userId, final String acspNumber ) {
    ...
    public AcspMembership createMembership( final User user, final AcspProfile acspProfile, final UserRoleEnum userRole, final String addedByUserId ) {
        ...
        final var proposedMembership = new StorageModel()

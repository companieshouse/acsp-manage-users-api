...
public abstract class CollectionTransformer extends Transformer {
    ...
    public List<AcspMembership> daoToDto( final List<StorageModel> acspMembers, final User userData, final AcspProfile acspProfile ){
    ...
    public AcspMembershipsList daoToDto( final Page<StorageModel> acspMembers, final User userData, final AcspProfile acspProfile ){

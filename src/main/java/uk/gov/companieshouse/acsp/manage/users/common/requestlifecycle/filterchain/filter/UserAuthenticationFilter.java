package uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.filter;

import static uk.gov.companieshouse.acsp.manage.users.common.model.context.RequestContext.setRequestContext;
import static uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.model.SpringRole.ADMIN_WITH_ACSP_SEARCH_PRIVILEGE_ROLE;
import static uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.model.SpringRole.BASIC_OAUTH_ROLE;
import static uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.model.SpringRole.KEY_ROLE;
import static uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.model.SpringRole.UNKNOWN_ROLE;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.LoggingUtil.LOGGER;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getActiveAcspNumber;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getActiveAcspRole;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getAdminPrivileges;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getEricAuthorisedKeyRoles;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getEricIdentity;
import static uk.gov.companieshouse.acsp.manage.users.common.utils.RequestContextUtil.getEricIdentityType;
...
import uk.gov.companieshouse.acsp.manage.users.common.requestlifecycle.filterchain.model.SpringRole;
...
public class UserAuthenticationFilter extends OncePerRequestFilter {
    ...
    public UserAuthenticationFilter( final UsersService usersService, final MembershipService acspMembersService ){

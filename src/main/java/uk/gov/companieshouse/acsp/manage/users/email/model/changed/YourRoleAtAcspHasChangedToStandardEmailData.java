package uk.gov.companieshouse.acsp.manage.users.email.model.changed;

import static uk.gov.companieshouse.acsp.manage.users.email.model.MessageType.YOUR_ROLE_AT_ACSP_HAS_CHANGED_TO_STANDARD_MESSAGE_TYPE;

package uk.gov.companieshouse.acsp.manage.users.membership.transformer;
...
import static uk.gov.companieshouse.acsp.manage.users.testresources.DateUtils.localDateTimeToNormalisedString;
import static uk.gov.companieshouse.acsp.manage.users.testresources.DateUtils.reduceTimestampResolution;
...
class CollectionTransformerTest {
    ...
    @InjectMocks
    private CollectionTransformer acspMembershipCollectionMappers = new CollectionTransformerImpl();
    ...
    void daoToDtoWithNullInputThrowNullPointerException() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> acspMembershipCollectionMappers.daoToDto( (List<StorageModel>) null, userData, acspProfile ) );
    }
    ...
    void daoToDtoPageWithNullInputThrowNullPointerException() {
        final var userData = testDataManager.fetchUserDtos("TSU001").getFirst();
        final var acspProfile = testDataManager.fetchAcspProfiles( "TSA001" ).getFirst();
        Assertions.assertThrows(NullPointerException.class, () -> acspMembershipCollectionMappers.daoToDto( (Page<StorageModel>) null, userData, acspProfile ) );
    }

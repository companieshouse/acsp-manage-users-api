...
import uk.gov.companieshouse.acsp.manage.users.testresources.ComparisonUtils;
...
import static uk.gov.companieshouse.acsp.manage.users.testresources.ComparisonUtils.updateMatches;
...
class MembershipServiceTest {
    ...
    void addAcspMembershipReturnsAddedAcspMembership() {
        ...
        Mockito.doReturn( acspMembersDao ).when( acspMembersRepository ).insert( any( StorageModel.class ) );

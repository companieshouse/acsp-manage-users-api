...
class ReactiveUsersServiceTest {
    ...
    @InjectMocks
    private ReactiveUsersService reactiveUsersService;
    ...
    void fetchUserDetailsForNullOrNonexistentUserReturnsNotFoundRuntimeException() {
        ...
        Assertions.assertThrows( NotFoundRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( (String) null ) );

        mockWebClientForFetchUserDetailsErrorResponse( "404User", 404 );
        Assertions.assertThrows( NotFoundRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( "404User" ) );
    }
    ...
    void fetchUserDetailsWithMalformedUserIdReturnsInternalServerErrorRuntimeException() {
        ...
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( "£$@123" ) );
    }
    ...
    void fetchUserDetailsWithArbitraryErrorReturnsInternalServerErrorRuntimeException() {
        ...
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( "WITU001" ) );
    }

    @Test
    void fetchUserDetailsReturnsSpecifiedUser() throws JsonProcessingException {
        mockWebClientForFetchUserDetails( "WITU001" );
        Assertions.assertEquals( "Geralt of Rivia", reactiveUsersService.fetchUserDetails( "WITU001" ).getDisplayName() );
    }

    @Test
    void doesUserExistWithMalformedUserIdReturnsInternalServerErrorRuntimeException(){
        mockWebClientForFetchUserDetailsErrorResponse( "£$@123", 400 );
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.doesUserExist( "£$@123" ) );
    }

    @Test
    void doesUserExistWithArbitraryErrorReturnsInternalServerErrorRuntimeException() {
        mockWebClientForFetchUserDetailsJsonParsingError( "WITU001" );
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.doesUserExist( "WITU001" ) );
    }

    @Test
    void doesUserExistWithExistingUserReturnsTrue() throws JsonProcessingException {
        mockWebClientForFetchUserDetails( "WITU001" );
        Assertions.assertTrue( reactiveUsersService.doesUserExist( "WITU001" ) );
    }

    @Test
    void doesUserExistWithNullOrNonexistentUserReturnsFalse() {
        mockWebClientForFetchUserDetailsErrorResponse( null, 404 );
        Assertions.assertFalse( reactiveUsersService.doesUserExist( null ) );

        mockWebClientForFetchUserDetailsErrorResponse( "404User", 404 );
        Assertions.assertFalse( reactiveUsersService.doesUserExist( "404User" ) );
    }

    @Test
    void fetchUserDetailsWithNullStreamThrowsNullPointerException(){
        Assertions.assertThrows( NullPointerException.class, () -> reactiveUsersService.fetchUserDetails( (Stream<AcspMembersDao>) null ) );
    }

    @Test
    void fetchUserDetailsWithEmptyStreamReturnsEmptyMap() {
        Assertions.assertEquals( 0, reactiveUsersService.fetchUserDetails( Stream.of() ).size() );
    }
    ...
    void fetchUserDetailsWithStreamThatHasNonExistentUserReturnsNotFoundRuntimeException(){
        ...
        mockWebClientForFetchUserDetailsErrorResponse( "404User", 404 );
        Assertions.assertThrows( NotFoundRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( Stream.of( membership ) ) );
    }
    ...
    void fetchUserDetailsWithStreamThatHasMalformedUserIdReturnsInternalServerErrorRuntimeException(){
        ...
        mockWebClientForFetchUserDetailsErrorResponse( "£$@123", 400 );
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.fetchUserDetails( Stream.of( membership ) ) );
    }
    ...
    void fetchUserDetailsWithStreamReturnsMap() throws JsonProcessingException {
        final var membership = testDataManager.fetchAcspMembersDaos( "WIT001" ).getFirst();
        mockWebClientForFetchUserDetails( "WITU001" );
        final var users = reactiveUsersService.fetchUserDetails( Stream.of( membership, membership ) );
    ...
    void searchUserDetailsWithNullListThrowsNullPointerException(){
        Assertions.assertThrows( NullPointerException.class, () -> reactiveUsersService.searchUserDetails( null ) );
    }
    ...
    void searchUserDetailWithNullOrMalformedUserEmailThrowsInternalServerErrorRuntimeException() {
        ...
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.searchUserDetails( emails ) );

        mockWebClientForSearchUserDetailsErrorResponse( "£$@123", 400 );
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.searchUserDetails( List.of( "£$@123" ) ) );
    }

    @Test
    void searchUserDetailsReturnsUsersList() throws JsonProcessingException {
        mockWebClientForSearchUserDetails( "WITU001" );
        final var result = reactiveUsersService.searchUserDetails( List.of( "geralt@witcher.com" ) );
    ...
    void searchUserDetailsWithNonexistentEmailReturnsNull() {
        ...
        Assertions.assertNull( reactiveUsersService.searchUserDetails( List.of( "404@email.com" ) ) );
    }
    ...
    void searchUserDetailsWithArbitraryErrorReturnsInternalServerErrorRuntimeException() {
        ...
        Assertions.assertThrows( InternalServerErrorRuntimeException.class, () -> reactiveUsersService.searchUserDetails( List.of( "geralt@witcher.com" ) ) );
    }

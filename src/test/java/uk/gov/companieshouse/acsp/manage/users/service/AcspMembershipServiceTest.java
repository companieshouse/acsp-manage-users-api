...
class AcspMembershipServiceTest {
  ...
  @InjectMocks AcspMembershipService acspMembershipService;

  @Mock AcspMembersRepository acspMembersRepository;
  @Mock AcspMembershipMapper acspMembershipMapper;
  ...
  public void setup() {
    ...
    acspMembershipService = new AcspMembershipService(acspMembersRepository, acspMembershipMapper);
  }

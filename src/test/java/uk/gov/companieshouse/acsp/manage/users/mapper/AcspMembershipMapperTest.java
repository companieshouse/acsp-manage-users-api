...
class AcspMembershipMapperTest {
  ...
  @InjectMocks private AcspMembershipMapper acspMembershipMapper;
  ...
  void daoToDtoAppliedToPartialDaoSuccessfullyMapsToDto() {
    ...
    Assertions.assertEquals(
        localDateTimeToNormalisedString(dao.getAddedAt()),
        reduceTimestampResolution(dto.getAddedAt().toString()));
  ...
  void daoToDtoAppliedToCompleteDaoSuccessfullyMapsToDto() {
    ...
    Assertions.assertEquals(
        localDateTimeToNormalisedString(dao.getRemovedAt()),
        reduceTimestampResolution(dto.getRemovedAt().toString()));
